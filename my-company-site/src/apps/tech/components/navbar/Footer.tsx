...
export default function Footer({ variant = "tech" }: FooterProps) {
  ...
  return (
    <footer className="bg-blue-950 text-gray-200">
        ...
        <div className="space-x-4">
          {footerData.cta.buttons.map((btn) => (
            <a
              ...
              className={
                btn.style === "primary"
                  ? "bg-white text-blue-600 px-4 py-2 rounded hover:text-white hover:bg-blue-600"
                  : "border border-white text-white px-4 py-2 rounded hover:bg-white hover:text-blue-600"
              }
            >
              {btn.label}
            </a>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 grid gap-8 md:grid-cols-4 text-white">
        ...
        {/* Quick Links */}
        <div className="grid grid-cols-2 gap-6 text-sm text-blue-200 hover:text-white rounded-full shadow transition">
